<div class="card  col-md-4 mx-auto mb-4 p-0" >
  ...
  {{-- <div class="">
      <div class="navbar bg-primary my-0" style="min-height: 50px" >
        <p class="py-0">
          <img class="rounded-circle col-md-2 p-0" style="max-width: 7%" src="{{$post->user->avatar}}"  alt="profile picture" >
